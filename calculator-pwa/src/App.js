    ...
    <div className="app">
     ...
     <h1 className='shopName'>{shopName}</h1>
      ...
      <div className='languageWrapper'>
       ...
       <input type="number" value = {sellingValue} pattern="[0-9]*" inputmode="numeric"  id="price" name="price" onChange ={(e)=>setsellingValue((e.target.value))}/><br/>

       </div>
       <label for="sprice">{perKgGram}</label><br/>
          <input type="number" id="sprice"  value = {originalValue} pattern="[0-9]*" inputmode="numeric"  name="sprice" onChange ={(e)=>setOriginalValue((e.target.value))}/><br/>
       </div>
